...
void sub_080762D8(ItemBehavior* this, u32 param_2) {
    u32 animIndex;

    gPlayerState.heldObject &= 0xcf;
    if (PlayerTryDropObject(this, param_2) == 0) {
        return;
    }
    ...
    if (gPlayerState.jump_status == 0) {
        ...
        if ((gPlayerState.heldObject == 1) && (sub_0800875A(&gPlayerEntity, 6, this) != 0)) {
            sub_08076088(this, NULL, param_2);
            return;
            ...
            sub_08076088(this, this->field_0x18, param_2);
        } else {
